...
public class VSDSubString {
	//Method to find substring in string
	public static void VSDfindSubString(String s, String sub) {
	...
	public static void VSDuserInput() {
		...
		String sub=sc.next();
		VSDfindSubString(s,sub);
	}
public static void main(String args[]) {
	VSDuserInput();//Function to read strings given by user
}
}
